...
parser.add_argument('--no_position', action='store_true')#args.threads
...
trC_docs = [doc for doc in nlp.pipe(trC_iter, batch_size=64)]
trQ_docs = [doc for doc in nlp.pipe(trQ_iter, batch_size=64)]
# tokens
...
devC_docs = [doc for doc in nlp.pipe(
    devC_iter, batch_size=64)]
devQ_docs = [doc for doc in nlp.pipe(
    devQ_iter, batch_size=64)]
# tokens
