...
function predict_quac {
    ...
    output_dir=./quac-models/predict/${seed}/${model}/${mode}
...
predict_quac  1023  0-pre        no-attack      -0.957
predict_quac  1023  3-pre        no-attack      -0.957

predict_quac  1023  only-first       no-attack  -0.957
predict_quac  1023  only-second      no-attack  -0.957
predict_quac  1023  only-third       no-attack  -0.957
predict_quac  1023  only-at-1        no-attack  -0.957


predict_quac  1023  no-position      no-attack  -0.957
predict_quac  1023  no-qt            no-attack  -0.957


predict_quac  1023  mask-pro         no-attack  -0.957
predict_quac  1023  mask-log         no-attack  -0.957
predict_quac  1023  mask-no-wh       no-attack  -0.957
predict_quac  1023  mask-only-wh     no-attack  -0.957
