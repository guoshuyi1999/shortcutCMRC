...
#no-question
# output_dir="CoQA_data/no-question/no-attack"
# if [[ ! -d "${output_dir}" ]]
# then
#     mkdir -p "${output_dir}"
# fi
...
# echo "Running command ${cmd[@]}" | tee "${output_dir}/preprocess_log.txt"
# ${cmd[@]} | tee -a "${output_dir}/preprocess_log.txt"
# cp "CoQA_data/dev.json" "${output_dir}/dev.json"

##mask
# output_dir="CoQA_data/mask-log/no-attack"
# if [[ ! -d "${output_dir}" ]]
# then
#     mkdir -p "${output_dir}"
# fi
...
output_dir="CoQA_data/mask-pro/no-attack"
if [[ ! -d "${output_dir}" ]]
then
    mkdir -p "${output_dir}"
fi
...
# output_dir="CoQA_data/mask-no-wh/no-attack"
# if [[ ! -d "${output_dir}" ]]
# then
#     mkdir -p "${output_dir}"
# fi
...
# output_dir="CoQA_data/mask-only-wh/no-attack"
# if [[ ! -d "${output_dir}" ]]
# then
#     mkdir -p "${output_dir}"
# fi
